...
module.exports = {
    ...
    async execute(interaction, client) {
        if (interaction.guild === null) {
            ...
            console.log(
                await db.get(`guild.${interaction.guild.id}.enemies.guilds`)
            );
            console.log(
                await db.get(`guild.${interaction.guild.id}.enemies.members`)
            );
            ...
            console.log(
                await db.get(`guild.${interaction.guild.id}.alliance.guilds`)
            );
            console.log(
                await db.get(`guild.${interaction.guild.id}.alliance.members`)
            );
            console.log("Staff");
            ...
            console.log(
                await db.get(
                    `guild.${interaction.guild.id}.lastMessage.enemies.channel`
                )
            );
